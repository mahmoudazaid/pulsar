...
### **Enhanced HTML Report (Masterthought)**
- **Combined UI + API** report generated by Masterthought (maven-cucumber-reporting)
- **Location**: `target/reports/cucumber-html-reports/overview-features.html`
...
- The workflow `.github/workflows/ci-cd-pipeline.yml` builds and publishes `target/reports/cucumber-html-reports` to **GitHub Pages**
- The Pages URL appears on the deployment job as the environment link (name: `github-pages`)
